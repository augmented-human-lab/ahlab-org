...
(function () {
  ...
  var SPECS = {
    ...
    'profile-edit': {
      // Kept for the case where myahl-forms.js's generic
      // delegation submits a profile-edit form. The dedicated
      // /people/<slug>/edit/ page bypasses myahl-forms.js and
      // calls AHLPatch.submit directly, so this spec is just for
      // backwards-compat with any other profile-edit triggers.
      targetType: 'profile',
      action:     'edit',
